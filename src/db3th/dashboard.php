...
<head>
    ...
    <title>Covid-Management | Dashboard</title>
...
$query7=mysqli_query($con,"select id from internationaltestrecord");
$totalintertest=mysqli_num_rows($query7);

$query11=mysqli_query($con,"select id from internationaltestrecord where ReportStatus='Assigned'");
$totalassigned+=mysqli_num_rows($query11);
//On the way for sample collection
$query21=mysqli_query($con,"select id from internationaltestrecord where ReportStatus='On the Way for Collection'");
$totalontheway+=mysqli_num_rows($query21);
//Sample Collected
$query31=mysqli_query($con,"select id from internationaltestrecord where ReportStatus='Sample Collected'");
$totalsamplecollected+=mysqli_num_rows($query31);
//Sent for lab
$query41=mysqli_query($con,"select id from internationaltestrecord where ReportStatus='Sent to Lab'");
$totalsenttolab+=mysqli_num_rows($query41);

//Report Delivered
$query51=mysqli_query($con,"select id from internationaltestrecord where ReportStatus='Delivered'");
$totaldelivered+=mysqli_num_rows($query51);

$query61=mysqli_query($con,"select id from internationalpatients");
$totalpatients+=mysqli_num_rows($query61); 
// ?>
...
<!-- Sent to Lab -->
 ...
 <!-- Total Registered Patients-->
                        <div class="col-xl-3 col-md-6 mb-4">
                            <div class="card border-left-primary shadow h-100 py-2">
                            <a href="total-registered-patients.php">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
            ...
            <!-- Total Registered Phlebotomist-->
                        ...
                        <div class="col-xl-3 col-md-6 mb-4">
                            <div class="card border-left-success shadow h-100 py-2">
                                      <a href="international-patient-test.php">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                   
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                              Total International Registered Test</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo $totalintertest;?></div>
                                        </div>
