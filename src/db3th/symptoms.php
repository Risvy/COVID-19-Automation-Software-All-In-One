...
<html lang="en">
<head>
  <title>Covid &mdash;COVID-19 Symptoms</title>
  <meta charset="utf-8">
  ...
  <?php include("file-css/style.css")?>
  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="navbarNavDropdown">
      <ul class="navbar-nav" style="margin-left:auto;">
        ...
        <li class="nav-item">
          <a class="nav-link active" aria-current="page" href="symptoms.php">Symptoms</a>
        </li>
        <li class="nav-item">
      ...
      <div class="container">
        <div class="row align-items-center">
          <div class="col-lg-6 mr-auto text-center text-lg-left">
            ...
            <p class="mb-5">COVID-19 affects different people in different ways. Most infected people will develop mild to moderate illness and recover without hospitalization.</p>
            <p class="mb-4"><a href="tel:09666777222" class="btn btn-primary">Call COVID-19 Telehealth</a></p>
      ...
      <div class="container">
        <div class="row mb-5">
          <div class="col-lg-7 mx-auto text-center">
            ...
            <p>Most common symptoms are listed below:</p>
          </div>
        </div>
        <div class="row">
          <div class="col-lg-6 mb-4">
            <div class="symptom d-flex">
              ...
              <div class="text">
                <h3>High Fever</h3>
                <p> This is one of the most common symptoms. Some might become seriously ill and require medical attention!</p>
              </div>
            </div>
          </div>
          <div class="col-lg-6 mb-4">
            <div class="symptom d-flex">
              ...
              <div class="text">
                <h3>Cough</h3>
                <p> One of the most common symptoms. Consult a doctor if needed.</p>
              </div>
            </div>
          </div>
          <div class="col-lg-6 mb-4">
            <div class="symptom d-flex">
              ...
              <div class="text">
                <h3>Sore Troath</h3>
                <p> Most people who experience this might recover without special treatment.</p>
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-6 mb-4">
            <div class="symptom d-flex">
              ...
              <div class="text">
                <h3>Headache</h3>
                <p> Most people who fall sick with COVID-19 might experience this symptom and recover without special treatment. </p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="row justify-content-md-center">
          <div class="col-lg-10">
            <div class="note row">
              ...
              <div class="col-lg-8 mb-4 mb-lg-0"><strong>Stay at home and call your doctor:</strong> Don't hesitate to consult a doctor if needed.</div>
              <div class="col-lg-4 text-lg-right">
                <a href="tel:333" class="btn btn-primary"><span class="icon-phone mr-2 mt-3"></span>Help line</a>
              </div>
            </div>
          </div>
        </div>
