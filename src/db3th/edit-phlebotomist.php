...
$query="update tblemployee set FullName='$fname',MobileNumber='$mnumber' where id='$pid'";
...
<head>
    ...
    <title>Covid-19 Testing Management System | Edit Employee</title>
...
<?php 
$pid=intval($_GET['pid']);
$query=mysqli_query($con,"select * from tblemployee where id='$pid'");
$cnt=1;
