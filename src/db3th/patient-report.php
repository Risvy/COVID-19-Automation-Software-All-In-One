...
?>
                    ...
                    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    <thead>
                                        <tr>
                                            <th>For International Travel</th>
                                            <th>Order No.</th>
                                            <th>Patient Name</th>
                                            <th>Mobile No.</th>
                                            <th>Test Type</th>
...
where (tblpatients.GovtIssuedId like '%$searchdata%' || tbltestrecord.OrderNumber like '%$searchdata%')
    ");
$cnt=1;
$result=mysqli_num_rows($query);
$query1=mysqli_query($con,"select internationaltestrecord.OrderNumber,internationalpatients.FullName,internationalpatients.MobileNumber,internationaltestrecord.TestType,internationaltestrecord.TestTimeSlot,internationaltestrecord.RegistrationDate,internationaltestrecord.id as testid from internationaltestrecord
join internationalpatients on internationalpatients.GovtIssuedId=internationaltestrecord.GovtIssuedId
where (internationalpatients.GovtIssuedId='$searchdata' || internationaltestrecord.OrderNumber='$searchdata')
    ");
...
<a href="patient-report-details.php?tid=<?php echo $row['testid'];?>&&oid=<?php echo $row['OrderNumber'];?>" class="btn btn-info btn-sm" target="blank">View Details</a> 
    ...
    <?php while($row1=mysqli_fetch_array($query1)){?>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $row1['TestType'];?></td>
                                            <td><?php echo $row1['TestTimeSlot'];?></td>
                                             <td><?php echo $row1['RegistrationDate'];?></td>
                                            <td>

                                <a href="inter-patient-report-details.php?tid=<?php echo $row1['testid'];?>&&oid=<?php echo $row1['OrderNumber'];?>" class="btn btn-info btn-sm" target="blank">View Details</a> 
