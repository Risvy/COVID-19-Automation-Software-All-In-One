...
$orderid=$_GET['oid'];
$r=mysqli_query($con,"select * from internationalpatients where OrderNumber='$orderid'");
...
$query=mysqli_query($con,"update internationaltestrecord set ReportStatus='$status',AssigntoName='$aname',AssignedtoEmpId='$pid',AssignedTime='$assigntime' where id='$testid'");
...
$query2=mysqli_query($con,"update internationaltestrecord set ReportStatus='$status',FinalReport='$newreportfile',ReportUploadTime='$uploadtime' where OrderNumber='$orderid'");
echo '<script>alert("Status updated successfully")</script>';
echo "<script>window.location.href='international-patient-test.php'</script>";
}

// For other status
else:
$query=mysqli_query($con,"insert into tblreporttracking(OrderNumber,Status,Remark,RemarkBy) values('$orderid','$status','$remark','$rby')");
$query2=mysqli_query($con,"update internationaltestrecord set ReportStatus='$status' where OrderNumber='$orderid'");
echo '<script>alert("Status updated successfully")</script>';
echo "<script>window.location.href='international-patient-test.php'</script>";
endif;  
...
<?php include_once('includes/sidebar.php');?>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
          ...
          <!-- Begin Page Content -->
            ...
            <!-- Page Heading -->
            <h1 class="h3 mb-4 text-gray-800">Test Details# <?php echo $_GET['oid'];?></h1>
              <div class="row">
              <?php 
              $testid=intval($_GET['tid']);
              $query=mysqli_query($con,"select * from internationaltestrecord
              join internationalpatients on internationalpatients.GovtIssuedId=internationaltestrecord.GovtIssuedId
              where  internationaltestrecord.id='$testid'");
                    ...
                    <div class="card-body">
                      ...
                      <table class="table table-bordered"  width="100%" cellspacing="0">
                        ...
                        <td><?php echo $row['FullName'];?></td>
                          ...
                          <tr>
                          <th>Passport Copy</th> 
                          <td> <img src="img/<?php echo $user['imgpath']?>" class="img-fluid" alt="passport copy"/></td>
                          </tr> 
                      </table>
                    </div>
                  </div>
                  ...
                  <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                      ...
                      <?php if($row['FinalReport']!=''):?>
                        <tr>
                          <th>Report</th> 
                          <td><a href="#" onclick="window.print();return false;"><center>Print this page</center></a></td>
...
<?php
$orderid=$_GET['oid'];
$otwfc="On The Way for Collection";
$sc="Sample Collected";
$stl="Sent to Lab";
$del="Delivered";
$ret1=mysqli_query($con,"select * from tblreporttracking
where OrderNumber='$orderid' and Status='$otwfc'");
$ret2=mysqli_query($con,"select * from tblreporttracking where OrderNumber='$orderid' and Status='$sc'");
$ret3=mysqli_query($con,"select * from tblreporttracking where OrderNumber='$orderid' and Status='$stl'");
$ret4=mysqli_query($con,"select * from tblreporttracking where OrderNumber='$orderid' and Status='$del'");
...
$res2=mysqli_fetch_array($ret2);
$res3=mysqli_fetch_array($ret3);
$res4=mysqli_fetch_array($ret4);
// var_dump($res1['Status']);
?>
                    ...
                    <div class="timeline__wrap">
                        <div class="timeline__items">
                            <div class="timeline__item">
                                ...
                                <?php if($num1<=0){
                                  echo '<p>Not Processed Yet</p>';
                                }
                                else{
                                echo '<p><strong>Date and Time: </strong>'.$res1['PostingTime'].'</p>';
                                }
                            ...
                            <div class="timeline__item">
                                ...
                                echo '<p><strong>Date and Time: </strong>'.$res2['PostingTime'].'</p>';
                                }
                                ?>
                                </div>
                            </div>
                            <div class="timeline__item">
                                ...
                                echo '<p><strong>Date and Time: </strong>'.$res3['PostingTime'].'</p>';
                                }
                                ?>
                               </div>
                            </div>
                            <div class="timeline__item">
                                ...
                                '<p><strong>Date and Time: </strong>'.$res4['PostingTime'].'</p>';
                                }
                                ?>
                                </div>
                            </div>
    ...
    <div class="modal-content">
      ...
      <form method="post">
                <p>  <select class="form-control" name="assignto" required="true">
                  ...
                  <?php $sql=mysqli_query($con,"select FullName,EmpID from tblemployee");
...
<form method="post" enctype="multipart/form-data" >
  ...
  $query1=mysqli_query($con,"select ReportStatus from internationaltestrecord where OrderNumber='$orderid'");
...
endwhile;
  ?>
       ...
       <p id='reportfile'> Report <span style="color:red; font-size:12px;">(Submit PDF)</span>    <input type="file" name="report" id="report"></p>
       <p>
